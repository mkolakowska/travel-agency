...
describe('Component OrderOption', () => {
  it('should render correct props', () => {
    ...
    const expectedName = 'pool';
    const component = shallow(
      <OrderOption type={expectedType} name={expectedName} />
    );
  ...
  describe(`Component OrderOption with type=${type}`, () => {
    ...
    switch (type) {
      ...
      case 'icons':
        {
          /* tests for icons */
          it('conains div with icons', () => {
            const containIcon = renderedSubcomponent.find('.icon');
            expect(containIcon.length).toBe(mockProps.values.length);
          });
